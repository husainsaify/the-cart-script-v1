	...
	<div class="row">
		...
		<div class="col-sm-8 padding-10 box-sizing">
			<div class="product-desc-container">
				...
				<p class="text-20">Market Price <span class="text-line-through text-red">Rs <?php echo $product['mp'] ?></span> <span class="text-green">[<?php echo $product['off'];?> OFF]</span></p>
				<?php
					/*calculate the money saved (mp - sp)*/
					$saved = $product['mp'] - $product['sp'];
				?>
				<p class="text-orange">Save Rs <?php echo $saved; ?></p>
